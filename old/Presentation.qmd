...
| Tool          | Omics Type      | Notes                                  |
|---------------|-----------------|----------------------------------------|
| Fisher        | Transcriptomics | Simple ORA                             |
| GSEA          | Transcriptomics | Uses ranked gene list                  |
| TPEA          | Transcriptomics | Includes network structure             |
| PSEA          | Proteomics      | Works with spectral counts             |
| MetPA         | Metabolomics    | Requires compound annotation           |
| Mummichog     | Metabolomics    | Bypasses compound annotation           |
| iDEA          | scRNA-seq       | Bayesian modeling                      |
| RSS-E         | GWAS            | Regression using SNPs                  |
| GOmeth        | Epigenomics     | Corrects for gene length & CpG mapping |
| ActivePathway | Multi-omics     | Combines multiple data types           |
